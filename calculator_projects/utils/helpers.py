...
def defining_total_price(coefficient_of_project, duration_per_hour):
    ...
    total_price_stage_and_task = duration_per_hour * (labor_cost.total_cost - salary_cost + salary)
...
def process_formation_fields_with_labour_cost(obj):
    ...
    obj.salary_cost = obj.total_price_stage_and_task * labour_cost.percent_salary_cost

    obj.cost_price = obj.total_price_stage_and_task * labour_cost.percent_cost_price
    obj.contributions_to_IT_park = obj.total_price_stage_and_task * labour_cost.percent_contributions_to_IT_park

    obj.period_expenses = obj.total_price_stage_and_task * labour_cost.percent_period_expenses
    obj.save()
