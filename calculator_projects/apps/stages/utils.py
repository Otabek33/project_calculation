...
def generation_fields(project, stage_list):
...
def project_plan_update(obj):
    ...
    project_plan = generation_fields(project_plan, stage_plan_list)
    project_plan.save()
...
def project_fact_update(obj):
    ...
    project_fact = generation_fields(project_fact, stage_fact_list)
    project_fact.save()
