...
#                     labour_cost_update, labour_cost_update_status,
from calculator_projects.apps.labour_costs.views import (
    labour_cost_view, labour_cost_add, labour_cost_update)
...
urlpatterns = [
    ...
    # path("delete/", labour_cost_delete_without_id, name="delete_without_id"),
]
